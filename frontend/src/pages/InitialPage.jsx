    ...
    <>
      ...
      <section id="sobre">
        <Container className="mb-5">
          <p className="intro">
            Organizar viagens e eventos em grupo ficou muito mais fácil, evite
            confusões. O TravelHub centraliza tudo em um único lugar.
          </p>
            ...
            <Col>
              <Card className="cards-funcionalidades">
                <Card.Body>
                  ...
                  <Card.Text>
                    Crie e organize suas viagens ou eventos para seu grupo.
                  </Card.Text>
                </Card.Body>
              </Card>
            </Col>
